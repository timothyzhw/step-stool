...
class SpawnProcess {
     ...
     */
    static spawn(args, path) {
        const spawnedProcess = child_process_1.spawn(gitLocation, args);
                ...
                if (typeof code === 'string') {
                    if (code === 'ENOENT') {
                        ...
                        if (GitProcess.pathExists(path) === false) {
                            ...
                            code = 1;//errors_1.RepositoryDoesNotExistErrorCode;
                        }
                        else {
                            ...
                            code = 2;//errors_1.GitNotFoundErrorCode;
                        }
